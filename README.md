...
* The library must be developed in Java language.
...
* It is necessary to adapt previously created *self-written* helper classes `Stack` and `Queue` (you can reuse your solution from the *CPP2* project for this) and implement interfaces for them in Java. These classes must contain the following methods:
